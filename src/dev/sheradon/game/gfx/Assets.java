...
public class Assets
{
	...
	public static void init()
	{
		...
		cloud = sheet.crop(width * 2,height * 1, width, height);
		...
		player2_right[1] = sheet.crop(width * 4, height *4, width, height);
		player2_right[2] = sheet.crop(width * 5, height *4, width, height);
		...
		player2_left[0] = sheet.crop(width * 3, height *4, width, height);
		player2_left[1] = sheet.crop(width * 3, height *4, width, height);
		player2_left[2] = sheet.crop(width * 3, height *4, width, height);
